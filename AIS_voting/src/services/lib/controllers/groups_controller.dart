...
class GroupsController extends ResourceController {
  ...
  Future<Response> addGroup(@Bind.body() Group group) async {
    ...
    final query = Query<Group>(context)
      ...
      ..values.chosenCount = group.chosenCount
      ...
      ..values.managerRoule = group.managerRoule
      ..values.isUnregisterUserOnExit = group.isUnregisterUserOnExit
      ..values.isManagerCastingVote = group.isManagerCastingVote
      ..values.isFastRegistrationUsed = group.isFastRegistrationUsed
      ..values.isDeputyAutoRegistration = group.isDeputyAutoRegistration
      ..values.isManagerAutoRegistration = group.isManagerAutoRegistration
      ..values.isActive = group.isActive
      ..values.guests = group.guests
      ..values.unblockedMics = group.unblockedMics
      ..values.MicsNotActiveFrom = group.MicsNotActiveFrom
      ..values.managerTerminal = group.managerTerminal;
