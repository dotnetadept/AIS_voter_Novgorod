...
/// The method name to set window in bottom mode
const String _setWindowBottomModeMethod = 'setWindowBottomMode';

/// The method name to set window in fullscreen mode
const String _setWindowFullscreenModeMethod = 'setWindowFullscreenMode';
...
class WindowSizeChannel {
  ...
  /// Sets the window in bottom mode.
  void setWindowBottomMode() async {
    await _platformChannel.invokeMethod(_setWindowBottomModeMethod, []);
  }

  /// Sets window in fullscreen mode.
  void setWindowFullscreenMode() async {
    await _platformChannel.invokeMethod(_setWindowFullscreenModeMethod, []);
  }
