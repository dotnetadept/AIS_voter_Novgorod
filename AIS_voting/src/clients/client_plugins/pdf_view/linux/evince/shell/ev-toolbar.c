                         ...
                         GParamSpec   *pspec)
{
	...
	EvToolbarPrivate *priv = (EvToolbarPrivate *) GET_PRIVATE (ev_toolbar);

        switch (prop_id) {
        case PROP_WINDOW:
                priv->window = (EvWindow *)g_value_get_object (value);
                break;
        default:
...
ev_toolbar_constructed (GObject *object)
{
	...
	EvToolbarPrivate *priv = (EvToolbarPrivate *) GET_PRIVATE (ev_toolbar);
        ...
        // builder = gtk_builder_new_from_resource ("file:///home/vladimir/Desktop/evince-3.36.10/shell/evince-menus.ui");
...
ev_toolbar_has_visible_popups (EvToolbar *ev_toolbar)
{
        ...
        priv = (EvToolbarPrivate *) GET_PRIVATE (ev_toolbar);
