...
ev_zoom_action_set_zoom_level (EvZoomAction *zoom_action,
                               float         zoom)
{
	EvZoomActionPrivate *priv = (EvZoomActionPrivate *)GET_PRIVATE (zoom_action);
        gchar *zoom_str;
        float  zoom_perc;
        guint  i;
...
static gboolean
focus_out_cb1 (EvZoomAction *zoom_action)
{
        ev_zoom_action_update_zoom_level (zoom_action);
                             ...
                             GParamSpec   *pspec)
{
	...
	EvZoomActionPrivate *priv = (EvZoomActionPrivate *)GET_PRIVATE (zoom_action);
        ...
        case PROP_DOCUMENT_MODEL:
                priv->model = (EvDocumentModel *)g_value_get_object (value);
                break;
        case PROP_MENU:
                priv->menu = (GMenu *)g_value_dup_object (value);
                break;
        default:
...
ev_zoom_action_get_popup_shown (EvZoomAction *zoom_action)
{
	...
	priv = (EvZoomActionPrivate *)GET_PRIVATE (zoom_action);
