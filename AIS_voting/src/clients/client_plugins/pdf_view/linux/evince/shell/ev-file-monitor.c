...
ev_file_monitor_finalize (GObject *object)
{
	...
	EvFileMonitorPrivate *priv = (EvFileMonitorPrivate *)ev_file_monitor_get_instance_private (ev_monitor);
...
ev_file_monitor_new (const gchar *uri)
{
	...
	priv = (EvFileMonitorPrivate *)ev_file_monitor_get_instance_private (ev_monitor);
